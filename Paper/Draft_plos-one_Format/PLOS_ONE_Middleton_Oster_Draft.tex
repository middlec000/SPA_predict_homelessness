...
%The definition of homelessness used by the agencies that collected the homelessness data was the ``Category 1: Literally Homeless'' definition presented by HUD:
...
\begin{figure}[htb]
    ...
    \caption{Positive and negative cases on TOTAL\_60\_DAYS\_AMT over time.  \red{describe the figure here, briefly define variables...}  }
